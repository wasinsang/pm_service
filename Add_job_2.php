...
<head>
    ...
    <script type="text/javascript" src="../PM/js/bootstrap-filestyle.min.js"></script>
...
<h1>Input Detail Project Management</h1>
    <form class="form-horizontal" role="form" name="form1" action="process_add.php" method="post" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();">
      ...
      <div class="form-group">
		...
		<label for="lblSO" class="col-sm-2 control-label">SO :</label>
...
<!--------------------------- datepicker ---------------------------->
      ...
      <div class="form-group">
        <label for="DueDate" class="col-sm-2 control-label"> :</label>
        <div class="col-sm-2">
          <input type="text" class="form-control inputstl" id="datepicker" name="datepicker" placeholder="Select Date">(วันที่กำหนดขึ้น Project)
        </div>
      </div>
